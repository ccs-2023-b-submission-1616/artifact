...
%splice [ps_pre_ctls_cipher_suites] (gen_parser_prefix (`pre_ctls_cipher_suites))
...
%splice [ps_pre_ctls_cipher_suite] (gen_parser_prefix (`pre_ctls_cipher_suite))
...
%splice [ps_pre_ctls_certificate_verify_algorithm] (gen_parser_prefix (`pre_ctls_certificate_verify_algorithm))
...
%splice [ps_pre_ctls_random] (gen_parser_prefix (`pre_ctls_random))
...
%splice [ps_extensions_ctls_type] (gen_parser_prefix (`extensions_ctls_type))
...
%splice [ps_ctls_extensions] (gen_parser_prefix (`ctls_extensions))
...
%splice [ps_ctls_client_hello] (gen_parser_prefix (`ctls_client_hello))
...
%splice [ps_ctls_server_hello] (gen_parser_prefix (`ctls_server_hello))
...
%splice [ps_ctls_hello_retry_request] (gen_parser_prefix (`ctls_hello_retry_request))
...
%splice [ps_ctls_certificate_verify] (gen_parser_prefix (`ctls_certificate_verify))
...
%splice [ps_ctls_encrypted_extensions] (gen_parser_prefix (`ctls_encrypted_extensions))
