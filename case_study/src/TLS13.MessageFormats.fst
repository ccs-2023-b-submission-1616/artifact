...
%splice [ps_empty] (gen_parser_prefix (`empty))
...
%splice [ps_early_data_indication] (gen_parser_prefix (`early_data_indication))
...
%splice [ps_pre_shared_key_extension] (gen_parser_prefix (`pre_shared_key_extension))
...
%splice [ps_supported_versions] (gen_parser_prefix (`supported_versions))
...
%splice [ps_post_handshake_auth] (gen_parser_prefix (`post_handshake_auth))
...
%splice [ps_end_of_early_data] (gen_parser_prefix (`end_of_early_data))
